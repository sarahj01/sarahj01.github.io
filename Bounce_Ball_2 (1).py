...
while not done:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            balls.append(BouncingBall(pos[0],pos[1],10, 2, 30))
            print(pos[0], pos[1])        
    ...
    for x in balls:
        x.flashBounce(screen, possible_ball_colors, SCREEN_WIDTH, SCREEN_HEIGHT)
    
    Text = Font.render("HOLA, SOMOS CHICAS QUE CODIFICAN", True, BLACK)
